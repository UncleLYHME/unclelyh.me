...
- Added a GitHub Actions pipeline that publishes immutable full-commit and `latest` GHCR images for Coolify-managed deployments; excluded `.github` from the Nginx image context.
